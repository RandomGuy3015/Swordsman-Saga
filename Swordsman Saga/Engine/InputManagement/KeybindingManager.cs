...
public class KeybindingManager
{
    ...
    public void SaveData(ref KeyBindingData gameData)
    {
        gameData.mKeyBindings = this.mKeyBindings;
    }
    ...
    private void SetDefaultBindings()
        {
            mKeyBindings = new Dictionary<ActionType, IEvent>
            {
                ...
                { ActionType.DebugReduceFriendlyTownHallHealth, new KeyEvent(EventType.OnButtonPress, Keys.N)},
                { ActionType.DebugReduceEnemyTownHallHealth, new KeyEvent(EventType.OnButtonPress, Keys.V) },
                { ActionType.DebugViewEnemyBase, new KeyEvent(EventType.OnButtonPress, Keys.C) },
        ...
        public void LoadData(KeyBindingData data)
        {
            mKeyBindings= data.mKeyBindings;
        }
