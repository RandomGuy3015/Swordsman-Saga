...
public class MusicVolumeOption : IOption
{
    ...
    public string Name { get; set; } = "MusicVolume";

    public MusicVolumeOption(SoundManager soundManager, int value)
    {
    ...
    public void SaveOption()
    {
        ...
        mSoundManager.SetBackgroundMusicVolume(Value);
    }
}